p2 = MixedIntegerLinearProgram(maximization=True, base_ring=QQ, solver="InteractiveLP")  
...
p2.set_objective(2*(x[0]*r1 + x[1]*r2 + x[2]*r3 + x[3]*r4 + x[4]*r5 + x[5]*r6 + x[6]*r7 + x[7]*r8 + x[8]*r9) - ((1/24) * sum([x[o] for o in range(9,33)])))
